...
class OrdersValidator():
    ...
    def check_duplicates(self):
        ...
        return pd.Series("duplicate_order_id", index=order_ids.values)
    ...
    def check_valide_status(self):
        ...
        return pd.Series("invalid_status", index=order_ids.values)
    ...
    def invalid_date(self):
        ...
        return pd.Series("invalid_date", index=order_ids.values)
    ...
    def invalid_date_order(self):
        ...
        return pd.Series("invalid_date_sequence", index=order_ids.values)