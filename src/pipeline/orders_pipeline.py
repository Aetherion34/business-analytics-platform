...
def run():
    ...
    product_ids =  Loader.load_products(DATA_DIR / "olist_products_dataset.csv", column = ["product_id"])["product_id"]
    order_ids = Loader.load_orders(DATA_DIR / "olist_orders_dataset.csv", column = ["order_id"])["order_id"]
    seller_ids = Loader.load_sellers(DATA_DIR / "olist_sellers_dataset.csv", column = ["seller_id"])["seller_id"]
